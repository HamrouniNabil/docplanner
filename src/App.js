...
function App() {
  ...
  const boxArray = [
    {
      ...
      tag : "Poland, Turkey, Spain, Italy, Czech Republic, Mexico, Brazil, Colombia, Argentina and Chile",
  ...
  return (
    <div>
      ...
      <div>
        <img src={logoDoc} className="logo1" />
      </div>
      <h3>
      ...
      <div className="main-title">
                   ...
                   <p className="main-text"> We work from 6 offices all over the world, bringing Docplanner Group to life in almost 20 countries.</p>
                   <img className="main-logo" src={logoDocPl}/>
                    </div>
      ...
      <div className="center-title">
            <p className="title3">Improve the lives of millions. Change yours forever</p>
      </div>
      <div className="center-title">
<p className="text6"> than 1000 team mates share our same vision, goals and passion. With offices in Warsaw, Barcelona, Istanbul, Rome, Mexico City and Curitiba, our search for great talent never stops.</p>
</div>
<div>
...
<div class="foot">
            <div >
            <hr/>
            <p class="text-foot">We are leaders in 10 countries: <a href="">Poland</a>, <a href="">Turkey</a>,<a href="">Spain</a>, <a href="">Italy</a>, <a href="">Czech Republic</a>, <a href="">Mexico</a>, <a href="">Colombia</a>, <a href="">Brazil</a>,<a href="">Argentina</a> and <a href="">Chile</a>
